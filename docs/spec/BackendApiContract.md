...
| GET | `/qsl-card/-/qsos?callSign=...` | 查询实体卡 QSO，返回 `selectable/unselectableReason` 兼容字段及 `statusCode/statusText/statusTextEn`；状态覆盖可申请、可重新申请、审核、建卡、制卡、打包、发卡和签收进度 | 是 |
